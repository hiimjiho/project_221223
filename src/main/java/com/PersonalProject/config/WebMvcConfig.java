...
import com.PersonalProject.interceptor.PermissionInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer{
	...
	// intercepter 설정 추가
		public void addInterceptors(InterceptorRegistry registry) {
			...
			.excludePathPatterns("/favicon.ico", "/error", "/static/**", "/user/sign_out", "/user/profile_update");	// 인터셉터를 제외할 url 패턴 등록
		}
}