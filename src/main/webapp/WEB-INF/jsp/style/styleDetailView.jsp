...
<div class="d-flex justify-content-center">
	<div class="contents-box">
		...
		<div>
			<a href="/profile/profile_view?userId=${styleCard.style.userId}" class="profileSend"><img src="${styleCard.user.profileImagePath}" onerror=this.src="/static/img/user/empty_profile.png" alt="프로필 사진" width=60px height=50px class="profileImg"></a>
